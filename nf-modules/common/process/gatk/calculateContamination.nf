...
process calculateContamination {
  ...
  output:
  tuple val(meta), path("${meta.tumor_id}_contamination.table.tsv"), emit: contaminationTable
  ...
  gatk --java-options "-Xmx${task.memory.toGiga()}g" \
    ...
    -I ${meta.tumor_id}_pileupsummaries.table.tsv \
    -O ${meta.tumor_id}_contamination.table.tsv
  """
}
